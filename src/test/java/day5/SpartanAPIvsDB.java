...
public class SpartanAPIvsDB extends SpartanTestBase {
    ...
    @Test
    public void testDB1(){
        //get name, gende, phone from database
      ...
      //Deserialization here json  to Java with Jackson objecMapper
      Map<String, Object> apiMap = response.as(Map.class);
        System.out.println(apiMap);

        //3.compare database verses API we assueme expected result is DB
